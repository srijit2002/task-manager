          ...
          <main className="page__details">
            ...
            <Form action="" method="POST" className="form" onSubmit={handleSubmit}>
              <div className="form__inputs">
                <input value={email} onChange={e=>setEmail(e.target.value)} name="email" required placeholder="Email"type="email" className="form__email" />
                <input value={password} onChange={e=>setPassword(e.target.value)} name="password" required placeholder="Password"type="password" className="form__password" />
              </div>
              ...
              <h3 className="secondary__link">Don't have an account?<Link to="/register">Create a new one</Link></h3>
            </Form>
          </main>
        </FormWrapper>
      </PageWrapper>
